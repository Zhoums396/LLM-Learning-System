...
# 读取test.json文件
# with open('C:/Users/Administrator/Desktop/CJEval/CJEval/CJEval/train/train_初中物理.json', 'r', encoding='utf-8') as f:
#     data = json.load(f)
